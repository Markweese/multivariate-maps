<template>
  <div v-bind:class='{"infopane": true, "--left": position, "--right": !position}'>
    <div class='infopane--wrapper'>
      ...
      <h3 class='--ice' v-if='active.errorCode === "Ice"'>Iced</h3>
      <h3 v-if='active.y === -1 && active.errorCode === "Ice"'>Iced</h3>
      ...
      <h3 v-else-if='active.y === -1 && typeof active.errorCode === "string"'>Meter Issue (<a href="https://help.waterdata.usgs.gov/codes-and-parameters/instantaneous-and-daily-value-status-codes" target="_blank">{{active.errorCode}}</a>)</h3>
