<template>
  <div class='mobile-chart'>
    ...
    <div v-if='point.y' class='mobile-chart__overview'>
    ...
    <div class='mobile-chart__bars'>
      <div class='mobile-chart__bars--bar'>
        <p v-if='point.y == 0 && units == "CFS"' class='--ice'>Iced</p>
        <p v-if='point.y' class='mobile-chart__bars--reading'>Reading: {{round(point.y, 2)}}<span>{{units}}</span></p>
